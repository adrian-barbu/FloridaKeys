...
/**
 * @description Venue Event Fragment
...
public class VenueEventFragment extends BaseFragment implements OnItemClickListener
{
    // UI Members
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mRootView = inflater.inflate(R.layout.fragment_venue_events, container, false);
        return mRootView;
    }
    ...
    private void doRequestLoadMore() {
        ...
        callWebService(netConfig.SERVICE_VENUE_EVENTS, params, mResponseHandler);
    }
